...
-  Table \@ref(tab:load-summary-table) shows that if national polls are carrying the error they exhibited in 2019, the election is closer to 51/49 ALP/Coalition in two-party preferred terms.
...
- It is extremely unlikely that the Coalition can form government with a national 2PP vote of 47%.   

- The Coalition _did_ form government in 1998 with 49% of the national 2PP.
